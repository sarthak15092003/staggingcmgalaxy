	...
	<?php if ( is_singular( 'post' ) ) : ?>
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'cmg-blog-single-article' ); ?>>
			...
			<div class="cmg-blog-layout-wrapper">
				...
				<div class="page-content cmg-blog-content" style="flex: 1 1 auto; min-width: 0; max-width: 960px; text-align: left; font-size: 16px; line-height: 1.75; color: #374151; box-sizing: border-box; padding: 0 20px;">
					<?php the_content(); ?>
